...
class Converter {
    ...
    deeplyCopy(node) {
         ...
         */
        if (this.options.errorOnUnknownASTType && !ast_node_types_1.AST_NODE_TYPES[customType]) {
        ...
        switch (node.kind) {
            case SyntaxKind.PropertyAccessExpression:
                result = this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.JSXMemberExpression,
            ...
            case SyntaxKind.ThisKeyword:
                result = this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.JSXIdentifier,
                    name: 'this'
                });
                break;
    ...
    convertNode(node, parent) {
        switch (node.kind) {
            ...
            case SyntaxKind.ContinueStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.ContinueStatement,
                    label: this.convertChild(node.label)
                });
            case SyntaxKind.BreakStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.BreakStatement,
                    label: this.convertChild(node.label)
                });
            // Choice
            ...
            case SyntaxKind.ForInStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.ForInStatement,
            ...
            case SyntaxKind.ForOfStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.ForOfStatement,
                    left: this.convertPattern(node.initializer),
                    right: this.convertChild(node.expression),
                    body: this.convertChild(node.statement),
            ...
            case SyntaxKind.FunctionDeclaration: {
                ...
                const result = this.createNode(node, {
                    type: isDeclare || !node.body
                        ? ast_node_types_1.AST_NODE_TYPES.TSDeclareFunction
                        : ast_node_types_1.AST_NODE_TYPES.FunctionDeclaration,
                ...
                // check for exports
                return node_utils_1.fixExports(node, result, this.ast);
            }
            ...
            case SyntaxKind.PropertyDeclaration: {
                ...
                if (result.key.type === ast_node_types_1.AST_NODE_TYPES.Literal && node.questionToken) {
                    result.optional = true;
                }
                return result;
            }
            ...
            case SyntaxKind.ClassExpression: {
                ...
                let classNodeType = node.kind === SyntaxKind.ClassDeclaration
                    ? ast_node_types_1.AST_NODE_TYPES.ClassDeclaration
                    : ast_node_types_1.AST_NODE_TYPES.ClassExpression;
            ...
            case SyntaxKind.PostfixUnaryExpression: {
                ...
                if (/^(?:\+\+|--)$/.test(operator)) {
                    return this.createNode(node, {
                        type: ast_node_types_1.AST_NODE_TYPES.UpdateExpression,
                        operator,
            ...
            case SyntaxKind.BinaryExpression: {
                ...
                if (node_utils_1.isComma(node.operatorToken)) {
                    ...
                    const left = this.convertChild(node.left), right = this.convertChild(node.right);
                    ...
                    return this.createNode(node, {
                        ...
                        left: this.converter(node.left, node, this.inTypeMode, type === ast_node_types_1.AST_NODE_TYPES.AssignmentExpression),
                        right: this.convertChild(node.right)
                    });
                }
            }
            ...
            case SyntaxKind.EmptyStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.EmptyStatement
                });
            case SyntaxKind.DebuggerStatement:
                return this.createNode(node, {
                    type: ast_node_types_1.AST_NODE_TYPES.DebuggerStatement
                });
            // JSX
            ...
            case SyntaxKind.JsxExpression: {
                ...
                if (node.dotDotDotToken) {
                    return this.createNode(node, {
                        type: ast_node_types_1.AST_NODE_TYPES.JSXSpreadChild,
                        expression
                    });
                }
                else {
                    return this.createNode(node, {
                        type: ast_node_types_1.AST_NODE_TYPES.JSXExpressionContainer,
                        expression
                    });
                }
            }
            ...
            case SyntaxKind.JsxText: {
                ...
                if (this.options.useJSXTextNode) {
                    return this.createNode(node, {
                        type: ast_node_types_1.AST_NODE_TYPES.JSXText,
            ...
            case SyntaxKind.ExpressionWithTypeArguments: {
                const result = this.createNode(node, {
                    type: parent && parent.kind === SyntaxKind.InterfaceDeclaration
                        ? ast_node_types_1.AST_NODE_TYPES.TSInterfaceHeritage
                        : ast_node_types_1.AST_NODE_TYPES.TSClassImplements,
                    expression: this.convertChild(node.expression)
                });
                if (node.typeArguments) {
                    result.typeParameters = this.convertTypeArgumentsToTypeParameters(node.typeArguments);
