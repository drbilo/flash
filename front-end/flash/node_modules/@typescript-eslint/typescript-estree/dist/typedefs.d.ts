...
export declare type TokenType = 'Boolean' | 'Identifier' | 'JSXIdentifier' | 'JSXMemberExpression' | 'JSXText' | 'Keyword' | 'Null' | 'Numeric' | 'Punctuator' | 'RegularExpression' | 'String' | 'Template';
...
export declare type ClassElement = ClassProperty | FunctionExpression | MethodDefinition | TSAbstractClassProperty | TSAbstractMethodDefinition | TSIndexSignature;
...
export declare type ExportDeclaration = ClassDeclaration | ClassExpression | FunctionDeclaration | TSDeclareFunction | TSEnumDeclaration | TSInterfaceDeclaration | TSModuleDeclaration | TSTypeAliasDeclaration | VariableDeclarator;
